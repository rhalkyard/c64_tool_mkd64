...
$(call zinc, src/lib/mkd64/bootblk/bootblk.mk)
$(call zinc, src/lib/mkd64/sepgen/sepgen.mk)
$(call zinc, src/lib/mkd64/xtracks/xtracks.mk)

$(mkd64_OBJDIR)$(PSEP)mkd64.d \
$(cbmdos_OBJDIR)$(PSEP)module.d \
$(sepgen_OBJDIR)$(PSEP)module.d \
$(xtracks_OBJDIR)$(PSEP)module.d \
$(bootblk_OBJDIR)$(PSEP)module.d: \
